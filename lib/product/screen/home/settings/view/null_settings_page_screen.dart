...
class NullSettingsPageScreen extends StatefulWidget {
  const NullSettingsPageScreen({Key? key}) : super(key: key);

  @override
  State<NullSettingsPageScreen> createState() => _NullSettingsPageScreenState();
}

class _NullSettingsPageScreenState extends State<NullSettingsPageScreen> {
  String textData = '';
  getFileData() async {
    String privacyText;
    privacyText =
